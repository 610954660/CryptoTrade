...
INDICATORS: Dict[str, dict] = {
    "boll": {
        ...
        "patterns": [
            ...
            {"key": "mid_trend_up",   "label": "中轨上行",         "value_required": False, "mode": "state"},
            {"key": "mid_trend_down", "label": "中轨下行",         "value_required": False, "mode": "state"},
            {"key": "boll_open",      "label": "BOLL 开口 (收窄后扩张)", "value_required": False, "mode": "state"},
            {"key": "boll_squeeze",   "label": "BOLL 收窄 (振幅缩小)",   "value_required": False, "mode": "state"},
        ],
    },
    "ma": {
        "label": "均线 (MA)",
